...
angular.module('sdm.authentication.services.angularOauth', ['sdm.popovers.services.sdmPopoverTrampoline']).
    ...
    provider('Token', [function() {
        ...
        this.$get = ['$q', '$http', '$window', '$rootScope', 'sdmPopoverTrampoline',
            function($q, $http, $window, $rootScope, sdmPopoverTrampoline) {
                        ...
                        iframe.onload = function() {
                            ...
                            if (!success){
                                sdmPopoverTrampoline.trigger(
                                    'sdm-login-modal',
                                    'components/authentication/loginModal.html');
